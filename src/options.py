...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument("--scheme-color", type=float, nargs='+', default=[65.04, -25.06, -29.04], help='color scheme for color loss function')
        parser.add_argument('--augment', type=str2bool, default=False, help='True for augmentation (default: True)')
        parser.add_argument('--label-smoothing', type=str2bool, default=1, help='True for one-sided label smoothing (default: False)')
